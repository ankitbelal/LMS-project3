    ...
    <style>
        * {
        ...
        .email-sent-success {
         ...
         /* New style for email sent success message */
         .email-sent-success {
            background-color: #4CAF50;
            color: white;
            text-align: center;
   ...
   <div class="message" id="message">
    ...
    <script>
            ...
            if (messageDiv && messageDiv.textContent.trim() !== '') {
                ...
                if (messageDiv.classList.contains('success')) {
                    setTimeout(function() {
                        window.location.href = 'reset.php'; // Redirect to index.php
                    }, 1000); // 1 second
                }
            }
        });
        ...
        // Hide the email sent success message after 2 seconds
        const emailSentSuccess = document.getElementById('email-sent-success');
        if (emailSentSuccess) {
            setTimeout(() => {
                emailSentSuccess.style.display = 'none';
                window.location.href='login.php';
            }, 2000); // 2 seconds
        }

        const emailSentError = document.getElementById('email-sent-error');
